...
- [View Build File](https://github.com/rife2/bld-testng/blob/master/examples/example-project/src/bld/java/com/example/ExampleBuild.java)
- [View Wrapper Properties](https://github.com/rife2/bld-testng/blob/master/examples/example-project/lib/bld/bld-wrapper.properties)
